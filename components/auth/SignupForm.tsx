...
export default function SignupForm({ onToggleMode, onClose }: SignupFormProps) {
  ...
  if (success) {
    return (
      ...
      >
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-miracle-gold/20 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-miracle-green to-miracle-teal rounded-full mb-4">
            <Heart className="w-8 h-8 text-white" />
          </div>
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Welcome to Miracles!</h2>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-gradient-to-r from-miracle-gold to-miracle-coral text-white py-3 px-6 rounded-lg font-semibold hover:shadow-lg transition-all duration-200"
          >
            Got it!
          </motion.button>
        </div>
    ...
    >
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-miracle-gold/20">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Join the Miracle Community</h2>
          <p className="text-gray-600">Share your positive experiences with the world</p>
        </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white/90 text-gray-500">{t('auth.signUpWithGoogle')}</span>
            </div>
          </div>
